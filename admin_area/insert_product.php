...
Product Url Example : lipstick-10
...
<label class="col-md-3 control-label" > Select A Supplier</label>
...
<label class="col-md-3 control-label" > Product Selling Price </label>
...
<label class="col-md-3 control-label" > Product Search Keyword </label>
